...
import com.r1792.service.batteries.BatteryTestCompressor;
...
import static com.r1792.model.batteries.BatteryTest.TestType.SHORT;
...
public class BatteryTestController {
    ...
    public String listTests(@PathVariable Long batteryId, Model model) {
        ...
        return "batteries/battery-tests"; // thymeleaf page
    }
    ...
    public String showAddForm(Model model) {
        ...
        return "batteries/battery-test-form";
    }
    ...
    public String listAllTests(Model model) {
        ...
        return "batteries/all-battery-tests";
    }
    @GetMapping("/upload")
    public String uploadForm() {
        return "batteries/uploadTest"; // // long battery test upload
    }
...
//            IO.println("Date: " + date);
        ...
        return "batteries/uploadResult"; // display results
